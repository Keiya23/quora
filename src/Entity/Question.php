...
class Question
{
    ...
    #[Assert\Length(min: 5, minMessage: "Votre titre doit faire au moins 5 caractères", max: 255, maxMessage: "Votre titre est trop long")]
    private $title;

    #[ORM\Column(type: 'text')]
    #[Assert\NotBlank(message: "Veuillez détailler votre question")]
    #[Assert\Length(min: 5, minMessage: "Votre question doit faire au moins 5 caractères")]
    private $content;
